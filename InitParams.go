...
func InitParams() (string, bool, uint16, bool, uint16, bool, uint16, bool, uint16, bool, bool, bool,int) {
	...
	WindowPa = uint16(wpa)
	WindowFa = uint16(wfa)
	return Port, SaEnable, WindowSa, AEnable, WindowA, PaEnable, WindowPa, FaEnable, WindowFa, Debug, Daemon, Forever, taskRange
}